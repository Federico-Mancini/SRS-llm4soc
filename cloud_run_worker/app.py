...
from analyze_data import analyze_batch_sync, analyze_batch_sync_with_cache, analyze_batch_async
...
async def run_batch(request: Request):
    ...
    batch_result_list = analyze_batch_sync_with_cache(batch_df, batch_id)
